...
def main():
    ...
    data = {
        ...
        "charts": {
            ...
            "organisms": {"labels": ["Malicious", "EM (7F)", "Backdoor (8A)", "Deception (8G)"], "data": [round(dt.get("malicious", {}).get("auroc", 0), 3), round(em.get("detector_auroc", 0), 3), round(bd.get("detector_triggered", {}).get("auroc", 0), 3), round(dec.get("probe_auroc", 0), 3)]},
        },
    }
